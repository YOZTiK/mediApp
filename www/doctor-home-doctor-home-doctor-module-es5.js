...
var HomeDoctorPageRoutingModule = /** @class */ (function () {
    function HomeDoctorPageRoutingModule() {
    }
    ...
    return HomeDoctorPageRoutingModule;
}());
...
var HomeDoctorPage = /** @class */ (function () {
    function HomeDoctorPage(http, toastController) {
        this.http = http;
        this.toastController = toastController;
        this.datos = _common_global_constants__WEBPACK_IMPORTED_MODULE_2__["GlobalConstants"].doctorProfile;
    }
    HomeDoctorPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    HomeDoctorPage.prototype.presentToast = function (message, duration) {
    ...
    HomeDoctorPage.prototype.submit = function () {
        console.log('');
    };
    HomeDoctorPage.ctorParameters = function () { return [
...
//# sourceMappingURL=doctor-home-doctor-home-doctor-module-es5.js.map