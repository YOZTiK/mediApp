...
var HomePatientPageRoutingModule = /** @class */ (function () {
    function HomePatientPageRoutingModule() {
    }
    ...
    return HomePatientPageRoutingModule;
}());
...
var HomePatientPageModule = /** @class */ (function () {
    function HomePatientPageModule() {
    }
...
var HomePatientPage = /** @class */ (function () {
    function HomePatientPage(http, toastController) {
        this.http = http;
        this.toastController = toastController;
        this.datos = _common_global_constants__WEBPACK_IMPORTED_MODULE_2__["GlobalConstants"].patientProfile;
    }
    HomePatientPage.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get(_common_global_constants__WEBPACK_IMPORTED_MODULE_2__["GlobalConstants"].dbURL + 'pacientes/' + _common_global_constants__WEBPACK_IMPORTED_MODULE_2__["GlobalConstants"].patientProfile.uid, {}, {})
            ...
            _this.presentToast('HTTP Request ' + error.status + ' ' + error.error + '');
        });
    };
    HomePatientPage.prototype.presentToast = function (message, duration) {
    ...
    HomePatientPage.ctorParameters = function () { return [
...
//# sourceMappingURL=patient-home-patient-home-patient-module-es5.js.map